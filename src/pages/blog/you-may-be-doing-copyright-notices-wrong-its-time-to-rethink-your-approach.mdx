...
However, this format can be misleading. The purpose of a copyright notice is to indicate the first date of publication for all content on the website. Consequently, the date should not be changed every year, as this would alter the "first publication" date.
