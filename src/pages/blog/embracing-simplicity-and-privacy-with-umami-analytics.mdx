...
Over the years, I've been frequently asked about my preferred tool for web analytics. Having experimented with a myriad of solutions, I've developed a particular fondness for [umami](https://umami.is/).
...
- **Access control & Teams**: Umami allows for the creation of unlimited users, each with distinct login details and website analytics. This flexibility makes it perfect for both personal project analytics and client accounts, where permissions can be granted to view their specific website analytics. It even supports the creation of teams, enabling multiple users and sites to operate under a single entity.

### A peek at the dashboard
![Umami dashboard view 1](/images/blog/umami-view1.png)
![Umami dashboard view 2](/images/blog/umami-view2.png)
